...
import { GoogleDriveImportDialog } from '../google-drive/GoogleDriveImportDialog'

export function CreateOpportunityDialog() {
  const navigate = useNavigate()
  const { investmentTypes, loadingInvestmentTypes, fetchInvestmentTypes, fetchOpportunities } = useDealsStore()
  ...
  function handleDriveImportClose() {
  ...
  return (
    <>
      ...
      {showDriveImport && (
        <GoogleDriveImportDialog onClose={handleDriveImportClose} />
      )}
    </>
  )
}
