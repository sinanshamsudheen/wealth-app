...
export const MOCK_DOCUMENTS: WorkspaceDocument[] = [
  ...
  },
  {
    ...
    content: JSON.stringify({
      elements: [
        { id: 'title', type: 'text', x: 300, y: 30, width: 400, height: 35, text: 'Abingworth VIII — Brainstorm', fontSize: 28, fontFamily: 1, textAlign: 'center', strokeColor: '#1e1e1e', backgroundColor: 'transparent', fillStyle: 'solid', strokeWidth: 1, roughness: 1, opacity: 100, angle: 0, groupIds: [], roundness: null, seed: 1, version: 1, versionNonce: 1, isDeleted: false, boundElements: null, updated: 1, link: null, locked: false, lineHeight: 1.25 },
        { id: 'risk-box', type: 'rectangle', x: 50, y: 100, width: 250, height: 180, strokeColor: '#e03131', backgroundColor: '#ffc9c9', fillStyle: 'solid', strokeWidth: 2, roughness: 1, opacity: 100, angle: 0, groupIds: [], roundness: { type: 3 }, seed: 2, version: 1, versionNonce: 2, isDeleted: false, boundElements: null, updated: 1, link: null, locked: false },
        { id: 'risk-title', type: 'text', x: 70, y: 115, width: 200, height: 25, text: '⚠ Key Risks', fontSize: 20, fontFamily: 1, textAlign: 'left', strokeColor: '#e03131', backgroundColor: 'transparent', fillStyle: 'solid', strokeWidth: 1, roughness: 1, opacity: 100, angle: 0, groupIds: [], roundness: null, seed: 3, version: 1, versionNonce: 3, isDeleted: false, boundElements: null, updated: 1, link: null, locked: false, lineHeight: 1.25 },
        { id: 'risk-text', type: 'text', x: 70, y: 150, width: 210, height: 100, text: 'Revenue miss:\nProjected $2.5B →\nactual $136M for 2024\n\nCustomer growth:\n0.49M actual users', fontSize: 14, fontFamily: 1, textAlign: 'left', strokeColor: '#1e1e1e', backgroundColor: 'transparent', fillStyle: 'solid', strokeWidth: 1, roughness: 1, opacity: 100, angle: 0, groupIds: [], roundness: null, seed: 4, version: 1, versionNonce: 4, isDeleted: false, boundElements: null, updated: 1, link: null, locked: false, lineHeight: 1.25 },
        { id: 'q-box', type: 'rectangle', x: 370, y: 100, width: 250, height: 180, strokeColor: '#e8590c', backgroundColor: '#fff3bf', fillStyle: 'solid', strokeWidth: 2, roughness: 1, opacity: 100, angle: 0, groupIds: [], roundness: { type: 3 }, seed: 5, version: 1, versionNonce: 5, isDeleted: false, boundElements: null, updated: 1, link: null, locked: false },
        { id: 'q-title', type: 'text', x: 390, y: 115, width: 200, height: 25, text: '❓ Open Questions', fontSize: 20, fontFamily: 1, textAlign: 'left', strokeColor: '#e8590c', backgroundColor: 'transparent', fillStyle: 'solid', strokeWidth: 1, roughness: 1, opacity: 100, angle: 0, groupIds: [], roundness: null, seed: 6, version: 1, versionNonce: 6, isDeleted: false, boundElements: null, updated: 1, link: null, locked: false, lineHeight: 1.25 },
        { id: 'q-text', type: 'text', x: 390, y: 150, width: 210, height: 100, text: 'Realistic CAC?\nIndustry: $100-300\n\nPath to profitability\nby 2026 — realistic?', fontSize: 14, fontFamily: 1, textAlign: 'left', strokeColor: '#1e1e1e', backgroundColor: 'transparent', fillStyle: 'solid', strokeWidth: 1, roughness: 1, opacity: 100, angle: 0, groupIds: [], roundness: null, seed: 7, version: 1, versionNonce: 7, isDeleted: false, boundElements: null, updated: 1, link: null, locked: false, lineHeight: 1.25 },
        { id: 'opp-box', type: 'rectangle', x: 690, y: 100, width: 250, height: 180, strokeColor: '#2f9e44', backgroundColor: '#d3f9d8', fillStyle: 'solid', strokeWidth: 2, roughness: 1, opacity: 100, angle: 0, groupIds: [], roundness: { type: 3 }, seed: 8, version: 1, versionNonce: 8, isDeleted: false, boundElements: null, updated: 1, link: null, locked: false },
        { id: 'opp-title', type: 'text', x: 710, y: 115, width: 200, height: 25, text: '✅ Opportunities', fontSize: 20, fontFamily: 1, textAlign: 'left', strokeColor: '#2f9e44', backgroundColor: 'transparent', fillStyle: 'solid', strokeWidth: 1, roughness: 1, opacity: 100, angle: 0, groupIds: [], roundness: null, seed: 9, version: 1, versionNonce: 9, isDeleted: false, boundElements: null, updated: 1, link: null, locked: false, lineHeight: 1.25 },
        { id: 'opp-text', type: 'text', x: 710, y: 150, width: 210, height: 100, text: '80% discount to Series\nE entry — attractive\n\nFull bank charter =\nstructural cost\nadvantage vs. competitors', fontSize: 14, fontFamily: 1, textAlign: 'left', strokeColor: '#1e1e1e', backgroundColor: 'transparent', fillStyle: 'solid', strokeWidth: 1, roughness: 1, opacity: 100, angle: 0, groupIds: [], roundness: null, seed: 10, version: 1, versionNonce: 10, isDeleted: false, boundElements: null, updated: 1, link: null, locked: false, lineHeight: 1.25 },
      ],
  ...
  },
  {
    ...
    content: JSON.stringify({
      elements: [
        { id: 'uaf-title', type: 'text', x: 200, y: 30, width: 500, height: 35, text: 'Meeting Notes — UAF Investment Committee', fontSize: 24, fontFamily: 1, textAlign: 'center', strokeColor: '#1e1e1e', backgroundColor: 'transparent', fillStyle: 'solid', strokeWidth: 1, roughness: 1, opacity: 100, angle: 0, groupIds: [], roundness: null, seed: 20, version: 1, versionNonce: 20, isDeleted: false, boundElements: null, updated: 1, link: null, locked: false, lineHeight: 1.25 },
        { id: 'uaf-date', type: 'text', x: 300, y: 70, width: 300, height: 20, text: 'April 8, 2026 • Raoof, Usman, Pine', fontSize: 14, fontFamily: 1, textAlign: 'center', strokeColor: '#868e96', backgroundColor: 'transparent', fillStyle: 'solid', strokeWidth: 1, roughness: 1, opacity: 100, angle: 0, groupIds: [], roundness: null, seed: 21, version: 1, versionNonce: 21, isDeleted: false, boundElements: null, updated: 1, link: null, locked: false, lineHeight: 1.25 },
        { id: 'decision-box', type: 'rectangle', x: 200, y: 120, width: 500, height: 80, strokeColor: '#2f9e44', backgroundColor: '#d3f9d8', fillStyle: 'solid', strokeWidth: 2, roughness: 1, opacity: 100, angle: 0, groupIds: [], roundness: { type: 3 }, seed: 22, version: 1, versionNonce: 22, isDeleted: false, boundElements: null, updated: 1, link: null, locked: false },
        { id: 'decision-text', type: 'text', x: 220, y: 135, width: 460, height: 50, text: 'DECISION: Proceed at $15M (reduced from $20M)\nContingent on reference checks completion', fontSize: 16, fontFamily: 1, textAlign: 'center', strokeColor: '#2f9e44', backgroundColor: 'transparent', fillStyle: 'solid', strokeWidth: 1, roughness: 1, opacity: 100, angle: 0, groupIds: [], roundness: null, seed: 23, version: 1, versionNonce: 23, isDeleted: false, boundElements: null, updated: 1, link: null, locked: false, lineHeight: 1.25 },
        { id: 'action-box', type: 'rectangle', x: 50, y: 240, width: 250, height: 120, strokeColor: '#1971c2', backgroundColor: '#d0ebff', fillStyle: 'solid', strokeWidth: 2, roughness: 1, opacity: 100, angle: 0, groupIds: [], roundness: { type: 3 }, seed: 24, version: 1, versionNonce: 24, isDeleted: false, boundElements: null, updated: 1, link: null, locked: false },
        { id: 'action-text', type: 'text', x: 70, y: 255, width: 210, height: 90, text: 'Action Items:\n• Request audited returns\n• Follow up with GP admin\n• 18mo lock stress test', fontSize: 14, fontFamily: 1, textAlign: 'left', strokeColor: '#1e1e1e', backgroundColor: 'transparent', fillStyle: 'solid', strokeWidth: 1, roughness: 1, opacity: 100, angle: 0, groupIds: [], roundness: null, seed: 25, version: 1, versionNonce: 25, isDeleted: false, boundElements: null, updated: 1, link: null, locked: false, lineHeight: 1.25 },
        { id: 'concern-box', type: 'rectangle', x: 600, y: 240, width: 250, height: 120, strokeColor: '#e8590c', backgroundColor: '#fff3bf', fillStyle: 'solid', strokeWidth: 2, roughness: 1, opacity: 100, angle: 0, groupIds: [], roundness: { type: 3 }, seed: 26, version: 1, versionNonce: 26, isDeleted: false, boundElements: null, updated: 1, link: null, locked: false },
        { id: 'concern-text', type: 'text', x: 620, y: 255, width: 210, height: 90, text: 'Concerns Raised:\n• Total healthcare exposure\n• Sensitivity analysis needed\n• Downside scenario review', fontSize: 14, fontFamily: 1, textAlign: 'left', strokeColor: '#1e1e1e', backgroundColor: 'transparent', fillStyle: 'solid', strokeWidth: 1, roughness: 1, opacity: 100, angle: 0, groupIds: [], roundness: null, seed: 27, version: 1, versionNonce: 27, isDeleted: false, boundElements: null, updated: 1, link: null, locked: false, lineHeight: 1.25 },
      ],
      appState: { viewBackgroundColor: '#ffffff' },
    }),
    version: 1,
